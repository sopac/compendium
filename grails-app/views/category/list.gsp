...
<div class="nav">
  ...
  <span class="menuButton"><g:link class="create" controller="project" action="create">New Collection</g:link></span>
</div>
<div class="body">
  <h1>Collection By ${category} Category</h1>
  ...
  <div class="paginateButtons">
    ${projectInstanceTotal} Projects in <b>${category}</b> Category
  </div>
</div>
</body>
</html>
