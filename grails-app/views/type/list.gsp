...
<div class="nav">
  ...
  <span class="menuButton"><g:link class="create" controller="project" action="create"><g:message code="default.new.label" args="[entityName]"/></g:link></span>
</div>
<div class="body">
  <h1>Listing ${type} Collections</h1>
  ...
  <div class="paginateButtons">
    ${projectInstanceTotal} <b>${type}</b> Projects
  </div>
</div>
</body>
</html>
