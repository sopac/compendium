...
<div class="body">
    ...
    <div class="dialog">
        <table>
            ...
            <tr class="prop">
                <td valign="top" class="name"><i><g:message code="project.type.label" default="Secondary Category"/></i>
                </td>
                ...
                <td valign="top" style="text-align: left;" class="value">
                    <ol>
                        ...
                        %{--<li><g:link controller="link" action="show" id="${l.id}">${l?.encodeAsHTML()}</g:link></li>--}%
                            <g:if test="${l.type.equals('Report')}">
                                <li style="margin-top: .5em; margin-bottom: .5em;"><a target="_blank" href="http://dev.sopac.org.fj/VirLib/${l.url}">${l?.encodeAsHTML()}</a>
                                </li>
                            </g:if>
                            <g:if test="${l.type.equals('Imagery')}">
                                <li style="margin-top: .5em; margin-bottom: .5em;">

                                    <a target="_blank" href="http://geonetwork.sopac.org/geonetwork/srv/en/main.home?uuid=${l.url}">
                                        <g:thumbnail uuid="${l.url}"></g:thumbnail><br/>
                                        ${l?.encodeAsHTML()}
                                    </a>
                                </li>
                            </g:if>
                            <g:if test="${l.type.equals('Document')}">
                                <li style="margin-top: .5em; margin-bottom: .5em;"><a target="_blank" href="http://ict.sopac.org/compendium-documents/${l.url}">${l?.encodeAsHTML()}</a>
                                </li>
                            </g:if>
                        </g:each>
                    </ol>
    ...
    <div class="buttons">
        <g:form>
            ...
            <span class="button"><g:actionSubmit class="delete" action="clearLinks" value="Clear Links" onclick="return confirm('Are you sure you want to clear all links from this project?');"/></span>
        </g:form>
    </div>
</div>
</body>
